...
@interface DDPhotoViewController ()<AVCaptureMetadataOutputObjectsDelegate,CAAnimationDelegate>
...
-(UIButton *)reCamButton{
    if (_reCamButton == nil) {
        ...
        [_reCamButton setTitle:[MDB_UserDefault getSetStringNmae:@"chongxinpaizhao"] forState:UIControlStateNormal];
...
-(UIButton *)selectButton{
    if (_selectButton == nil) {
        ...
        [_selectButton setTitle:[MDB_UserDefault getSetStringNmae:@"queding"] forState:UIControlStateNormal];
...
- (UILabel *)tishiLabel {
    ...
    if (_tishiLabel == nil) {
        ...
        _tishiLabel.text = [NSString stringWithFormat:@"%@\n%@",[MDB_UserDefault getSetStringNmae:@"qjshenfenzduicquyu"],[MDB_UserDefault getSetStringNmae:@"changshidqbianyuan"]];
...
- (BOOL)canUserCamear{
    ...
    if (authStatus == AVAuthorizationStatusDenied) {
        UIAlertController *alter = [UIAlertController alertControllerWithTitle:[MDB_UserDefault getSetStringNmae:@"qingdakaixjquanxian"] message:[MDB_UserDefault getSetStringNmae:@"shezhiysxiangji"] preferredStyle:UIAlertControllerStyleAlert];
        UIAlertAction *action = [UIAlertAction actionWithTitle:[MDB_UserDefault getSetStringNmae:@"queding"] style:0 handler:^(UIAlertAction * _Nonnull action) {
        ...
        UIAlertAction *action1 = [UIAlertAction actionWithTitle:[MDB_UserDefault getSetStringNmae:@"quxiao"] style:0 handler:^(UIAlertAction * _Nonnull action) {
