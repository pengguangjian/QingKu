...
@interface FuKuanMaViewController ()

@end

@implementation FuKuanMaViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = [MDB_UserDefault getSetStringNmae:@"fukuanma"];
    [self drawrightNav];
...
-(void)drawUI
{
    FuKuanMaView *view = [[FuKuanMaView alloc] init];
