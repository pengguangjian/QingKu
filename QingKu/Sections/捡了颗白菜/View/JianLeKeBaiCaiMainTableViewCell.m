//
//  JianLeKeBaiCaiMainTableViewCell.m
//  QingKu
//
...
@implementation JianLeKeBaiCaiMainTableViewCell
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if(self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])
    {
        ...
        UILabel *lbshop = [[UILabel alloc] init];
        [lbshop setText:@"商城或其他信息"];
        ...
        [lbshop mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.bottom.equalTo(imgvhead.mas_bottom);
            make.height.offset(20);
        }];
