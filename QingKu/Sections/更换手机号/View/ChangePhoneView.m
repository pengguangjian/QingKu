...
@interface ChangePhoneView ()<SelectCountryViewControllerDelegete>
{
...
-(void)drawUI
{
    ...
    [lbtop setText:[MDB_UserDefault getSetStringNmae:@"genghuanshoujihao"]];
    ...
    [lbtopmin setText:[MDB_UserDefault getSetStringNmae:@"shurugenghuanshoujihao"]];
